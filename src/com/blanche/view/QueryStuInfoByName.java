...
public class QueryStuInfoByName extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QueryStuInfoByName frame = new QueryStuInfoByName();
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
							...
							.addComponent(NameText, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
	...
	public void queryByStuNumActionPerformed(ActionEvent e) {
		...
		if (name.equals("")) {
			...
			students = studentInfoDao.queryByName(name); // bug,当点击玩查询全部时,再次点击查询,即便学院不存在,也显示最后一条数据.已解决,由于遍历全部数
