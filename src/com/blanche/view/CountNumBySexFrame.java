...
public class CountNumBySexFrame extends JInternalFrame {
...
//	private StudentInfo studentInfo;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CountNumBySexFrame frame = new CountNumBySexFrame();
	...
	public void fillTable(List<StudentInfo> students) {
		...
		for(int i=0;i<mySet.size();i++) {
			...
			currentRow.addElement(studentInfoDao.queryBySex(str).size() + "");
